...
def _get_builtin_stock_list():
    """
    內建台股代碼清單（上市+上櫃主要個股與ETF）。
    TWSE/TPEX API 無法連線時的 fallback，涵蓋主要成交量個股。
    """
    listed = [
        # ── 半導體 ──
        ("2330","台積電","上市"),("2303","聯電","上市"),("2311","日月光投控","上市"),
        ("2344","華邦電","上市"),("2408","南亞科","上市"),("2454","聯發科","上市"),
        ("3034","聯詠","上市"),("3037","欣興","上市"),("3711","日月光投控","上市"),
        ("6770","力積電","上市"),("8046","南電","上市"),("2325","矽品","上市"),
        ("3036","文曄","上市"),("2449","京元電子","上市"),("5347","世界先進","上市"),
        ("6415","矽力-KY","上市"),("2404","漢唐","上市"),("3231","緯創","上市"),
        ("2379","瑞昱","上市"),("2401","凌陽","上市"),("2458","義隆","上市"),
        ("3443","創意","上市"),("6153","嘉聯益","上市"),("2429","銘異","上市"),
        # ── 電子製造/代工 ──
        ("2317","鴻海","上市"),("2382","廣達","上市"),("2308","台達電","上市"),
        ("2357","華碩","上市"),("2376","技嘉","上市"),("2395","研華","上市"),
        ("3008","大立光","上市"),("2354","鴻準","上市"),("4938","和碩","上市"),
        ("2353","宏碁","上市"),("2301","光寶科","上市"),("2392","正崴","上市"),
        ("2385","群光","上市"),("2360","致茂","上市"),("2347","聯強","上市"),
        ("2360","致茂","上市"),("2474","可成","上市"),("2492","華新科","上市"),
        ("6669","緯穎","上市"),("2365","昆盈","上市"),("3023","信邦","上市"),
        ("2395","研華","上市"),("6278","台表科","上市"),("2313","華通","上市"),
        # ── 面板/光電 ──
        ("2409","友達","上市"),("3481","群創","上市"),("2393","億光","上市"),
        ("2412","中華電","上市"),("8299","群聯","上市"),("3707","漢微科","上市"),
        # ── 網通/電信 ──
        ("3045","台灣大","上市"),("4904","遠傳","上市"),("2412","中華電","上市"),
        ("3702","大聯大","上市"),("2388","威盛","上市"),("4906","正文","上市"),
        ("3093","港建","上市"),("2498","宏達電","上市"),
        # ── 金融銀行 ──
        ("2882","國泰金","上市"),("2881","富邦金","上市"),("2886","兆豐金","上市"),
        ("2884","玉山金","上市"),("2885","元大金","上市"),("2891","中信金","上市"),
        ("2892","第一金","上市"),("2880","華南金","上市"),("2883","開發金","上市"),
        ("5880","合庫金","上市"),("2887","台新金","上市"),("2888","新光金","上市"),
        ("2890","永豐金","上市"),("2801","彰銀","上市"),("5876","上海商銀","上市"),
        ("2823","中壽","上市"),("2824","台壽保","上市"),("2834","臺企銀","上市"),
        ("2836","高雄銀","上市"),("2838","聯邦銀","上市"),("2845","遠東銀","上市"),
        ("2849","安泰銀","上市"),("2850","新產","上市"),("2851","中再保","上市"),
        ("2852","第一保","上市"),("2855","統一證","上市"),("2867","三商壽","上市"),
        ("5820","日盛金","上市"),("6005","群益證","上市"),
        # ── 航運 ──
        ("2603","長榮","上市"),("2609","陽明","上市"),("2615","萬海","上市"),
        ("2618","長榮航","上市"),("2634","漢翔","上市"),("2637","慧洋-KY","上市"),
        ("2shipping","台航","上市"),("5703","大眾控","上市"),("2208","台船","上市"),
        ("2727","王品","上市"),("2236","萬里雲","上市"),
        # ── 塑化/石化 ──
        ("1301","台塑","上市"),("1303","南亞","上市"),("1326","台化","上市"),
        ("6505","台塑化","上市"),("1402","遠東新","上市"),("1308","亞聚","上市"),
        ("1309","台達化","上市"),("1310","台苯","上市"),("1312","國喬","上市"),
        ("1313","聯成","上市"),("1314","中石化","上市"),("1315","達新","上市"),
        ("1316","上曜","上市"),("1319","東陽","上市"),("1321","大洋","上市"),
        ("1323","永裕","上市"),("1324","地球","上市"),("1325","恆大","上市"),
        # ── 鋼鐵/金屬 ──
        ("2002","中鋼","上市"),("2006","東和鋼鐵","上市"),("2007","燁興","上市"),
        ("2008","高興昌","上市"),("2009","第一銅","上市"),("2010","春源鋼鐵","上市"),
        ("2011","鋼大","上市"),("2013","中鋼構","上市"),("2015","豐興","上市"),
        ("2017","官田鋼","上市"),("2020","美亞","上市"),("2022","聚亨","上市"),
        ("2023","燁輝","上市"),("2024","志聯","上市"),("2025","千興","上市"),
        # ── 水泥/建材 ──
        ("1101","台泥","上市"),("1102","亞泥","上市"),("1103","嘉泥","上市"),
        ("1104","環泥","上市"),("1108","幸福","上市"),("1109","信大","上市"),
        ("1110","東泥","上市"),
        # ── 食品/消費 ──
        ("1216","統一","上市"),("1210","大成","上市"),("1213","大飲","上市"),
        ("1215","卜蜂","上市"),("1218","泰山","上市"),("1219","福壽","上市"),
        ("1220","台榮","上市"),("1221","同榮","上市"),("1222","聚美","上市"),
        ("1225","福懋油","上市"),("1227","佳格","上市"),("1229","聯華","上市"),
        ("1231","聯華食","上市"),("1232","大統益","上市"),("1233","天仁","上市"),
        ("1234","黑松","上市"),("1235","興泰","上市"),("1236","宏亞","上市"),
        ("2727","王品","上市"),("2722","夏都","上市"),
        # ── 汽車/機械 ──
        ("2207","和泰車","上市"),("2105","正新","上市"),("2204","中華","上市"),
        ("2206","三陽工業","上市"),("1210","大成","上市"),("2103","台橡","上市"),
        ("2104","中橡","上市"),
        # ── 紡織 ──
        ("1402","遠東新","上市"),("1440","南紡","上市"),("1441","大東","上市"),
        ("1442","名軒","上市"),("1443","立益","上市"),("1444","力麗","上市"),
        ("1445","大宇","上市"),("1446","宏和","上市"),("1447","力鵬","上市"),
        ("1449","佳和","上市"),("1451","年興","上市"),("1452","宏益","上市"),
        # ── 能源/公用事業 ──
        ("9910","豐泰","上市"),("5347","世界先進","上市"),("6176","瑞儀","上市"),
        ("3714","富采","上市"),("2439","美律","上市"),
        # ── 其他電子 ──
        ("3035","智原","上市"),("3044","健鼎","上市"),("3046","建碁","上市"),
        ("3048","益登","上市"),("3051","力特","上市"),("3052","夆典","上市"),
        ("3059","華晶科","上市"),("3060","銘異","上市"),("3062","建漢","上市"),
        ("3063","遠見","上市"),("3064","泰偉","上市"),("3065","芬得科技","上市"),
        ("3078","僑威","上市"),("3081","聯亞","上市"),("3094","聯傑","上市"),
        ("3105","穩懋","上市"),("3149","正達","上市"),("3189","景碩","上市"),
        ("3260","威剛","上市"),("3406","玉晶光","上市"),("3515","華擎","上市"),
        ("3533","嘉澤","上市"),("3545","旭曜","上市"),("3548","長虹","上市"),
        ("3558","神準","上市"),("3563","牧德","上市"),("3576","新日興","上市"),
        ("3583","辛耘","上市"),("3587","閎康","上市"),("3588","通嘉","上市"),
        ("3596","研揚","上市"),("3702","大聯大","上市"),("3704","合勤控","上市"),
        ("3706","神達","上市"),("3709","鑫禾","上市"),("3715","定穎投控","上市"),
        ("3718","奇偶","上市"),("3726","漢磊","上市"),("3730","世紀眾成","上市"),
        # ── ETF 主要 ──
        ...
        ("00706","元大S&P石油","上市"),("00708L","期元大S&P黃金正2","上市"),
        ("0052","富邦科技","上市"),("0053","元大電子","上市"),
        ("0054","元大台商50","上市"),("0055","元大MSCI金融","上市"),
        ("00631L","元大台灣50正2","上市"),("00632R","元大台灣50反1","上市"),
        ("00690","兆豐藍籌30","上市"),("00692","富邦公司治理","上市"),
        ("00701","國泰台灣低波動30","上市"),("00713","元大台灣高息低波","上市"),
        ("00733","富邦臺灣中小","上市"),("00850","元大臺灣ESG永續","上市"),
        ("00905","野村全球電動車","上市"),("00911","兆豐台灣晶圓製造","上市"),
        ("00912","中信台灣智慧50","上市"),("00913","兆豐台灣晶圓製造","上市"),
        ("00915","凱基優選高股息30","上市"),("00916","國泰台灣科技100","上市"),
        ("00917","中信特選小台ETF","上市"),("00918","大華優利高填息30","上市"),
        ("00920","富邦台灣核心半導體","上市"),("00921","兆豐台灣晶圓製造","上市"),
        ("00922","國泰台灣ESG低碳50","上市"),("00923","群益台灣精選高息","上市"),
        ("00925","富邦特選高股息30","上市"),("00927","群益半導體收益","上市"),
        ("00930","永豐ESG低碳高息","上市"),("00931","野村優質高息","上市"),
        ("00932","兆豐永續高息等權","上市"),("00933","國泰台灣半導體","上市"),
        ("00934","中信成長高股息","上市"),("00935","野村台灣新科技50","上市"),
        ("00936","台新臺灣永續高息","上市"),("00937","統一台灣動能高息","上市"),
        ("00939","統一台灣科技金融","上市"),("00940","元大台灣價值高息","上市"),
        # ── 中租/租賃/其他 ──
        ("5871","中租-KY","上市"),("2867","三商壽","上市"),
        ("9917","中保科","上市"),("9939","宏全","上市"),("9945","潤泰全","上市"),
        ("9946","三發地產","上市"),("9955","佳龍","上市"),("9958","世紀鋼","上市"),
    ]

    otc = [
        # ── 上櫃半導體/IC設計 ──
        ("5269","祥碩","上櫃"),("3661","世芯-KY","上櫃"),("6488","環球晶","上櫃"),
        ("6533","晶心科","上櫃"),("3529","力旺","上櫃"),("4966","譜瑞-KY","上櫃"),
        ("6278","台表科","上櫃"),("6510","精測","上櫃"),("6409","旭隼","上櫃"),
        ("4958","臻鼎-KY","上櫃"),("3121","鉅詮","上櫃"),("6643","M31","上櫃"),
        ("6770","力積電","上市"),  # 已上市，保持相容
        ("3023","信邦","上櫃"),("3141","晶宏","上櫃"),("3665","貿聯-KY","上櫃"),
        ("6269","台郡","上櫃"),("6271","同欣電","上櫃"),("6789","采鈺","上櫃"),
        ("3691","碩禾","上櫃"),("4938","和碩","上市"),
        # ── 上櫃生技醫療 ──
        ("4170","新齊","上櫃"),("4174","浩鼎","上櫃"),("4175","聯生藥","上櫃"),
        ("4180","虹映","上櫃"),("4183","佑全","上櫃"),("4188","安基","上櫃"),
        ("4195","諾貝兒","上櫃"),("4196","安斯泰來","上櫃"),("4205","中華食","上櫃"),
        ("4207","環泰","上櫃"),("1789","神隆","上市"),("1788","中化生","上市"),
        ("4121","優盛","上櫃"),("4126","太醫","上櫃"),("4127","天良","上櫃"),
        ("4128","中天","上櫃"),("4129","聯合","上市"),("4130","健亞","上市"),
        # ── 上櫃軟體/網路 ──
        ("3141","晶宏","上櫃"),("5245","智晶","上櫃"),("5289","按必達","上櫃"),
        ("8299","群聯","上市"),("3630","新鉅科","上櫃"),
        # ── 上櫃金融 ──
        ("6592","和潤企業","上櫃"),("5871","中租-KY","上市"),
        ("5863","瑞興銀行","上市"),("5864","中華開發金","上市"),
        # ── 上櫃其他 ──
        ("3702","大聯大","上市"),("6121","新普","上櫃"),("3028","增你強","上櫃"),
        ("5274","信驊","上市"),("6414","樺漢","上市"),
        ("2233","宇隆","上市"),("1786","科妍","上市"),("2543","皇昌","上市"),
        ("2368","金像電","上市"),("3593","力銘","上市"),("9910","豐泰","上市"),
        ("8454","富邦媒","上市"),("2313","華通","上市"),("3533","嘉澤","上市"),
    ...
    seen = set()
    result = []
    for item in listed + otc:
        if item[0] not in seen and item[0].isdigit() or (len(item[0]) == 6 and item[0][:2] == '00'):
            seen.add(item[0])
            result.append(item)
    return result
